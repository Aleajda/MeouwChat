    ...
    if (props.isOwner){
        return (
            <div className={s.status}>
                ...
                ?
                <div>
                    <input style={props.dark ? {border: 'solid rgb(47, 248, 255) 2px'} : null} className={s.statusInput} onChange={ onStatusChange } onBlur = { deactivateEditMode } autoFocus={true} value={status}/>
                </div>
                :
                <div>
